...
// MongoDB connection
mongoose.connect(process.env.MONGODB_URI || 'mongodb://localhost:27017/d_app', {
...
app.get('/api/app-config', async (req, res) => {
  try {
    ...
    const config = {
      adminId: '695260a2929cbc79bb05e6f0',
      shopName: 'd',
...
app.listen(PORT, () => {
  console.log(`d Backend Server running on port ${PORT}`);
});
